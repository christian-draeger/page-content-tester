...
**Paco** is a Java based framework for non-blocking and highly parallelized Dom testing. Internally it's using jSoup to make http requests, so you can use all the provided methods of [jSoup](https://jsoup.org/) (server-side CSS3 selector driven DOM API, working for HTML & XML).
